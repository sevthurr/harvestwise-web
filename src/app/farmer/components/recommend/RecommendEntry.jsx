...
const RecommendEntry = ({
  ...
  const steps = [
    { num: "1", label: t("farmer.assess.step_choose_crop", {}, "Choose crop") },
    { num: "2", label: t("farmer.assess.step_planting_details", {}, "Planting details") },
    { num: "3", label: t("farmer.assess.step_costs_price", {}, "Cost and selling price") },
    { num: "4", label: t("farmer.assess.step_review_breakeven", {}, "Review Breakeven") }
  ];
  ...
  return (
    <div className="px-4 md:px-8 lg:px-10 py-5 pb-24 md:pb-8 max-w-[1440px] mx-auto space-y-6">
      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-[var(--hw-neutral-900)]">
            {t("farmer.assess.hero_title", {}, "Check what to plant")}
          </h1>
          <p className="mt-1.5 text-sm text-[var(--hw-neutral-900)] leading-relaxed">
            {t(
              "farmer.assess.hero_desc",
              {},
              "Tell us about your planting plan, expected costs, and possible harvest. HarvestWise will use this information to prepare a personalized recommendation."
            )}
          </p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-[var(--hw-neutral-200)] shadow-[var(--shadow-xs)] divide-y divide-[var(--hw-neutral-100)]">
        {steps.map((s) => (
          <div key={s.num} className="flex items-center gap-3 px-4 py-3">
      ...
      <div className="space-y-3">
        ...
        >
          {t("farmer.assess.start_assessment", {}, "Start assessment")}
        ...
        {hasDraft && (
          ...
          >
            ...
            {t("farmer.assess.continue_draft", {}, "Continue saved draft")}
          </button>
        )}
      </div>
      ...
      <div className="flex items-start gap-2 text-[var(--hw-neutral-700)]">
        ...
        <p className="text-xs leading-relaxed">
          {t("farmer.assess.results_disclaimer", {}, "Results are estimates and do not guarantee income.")}
        </p>
      </div>
    </div>
  );
