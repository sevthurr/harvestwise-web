...
const CropCard = ({ crop, onView }) => {
  ...
  const bottomText = crop.isOnHold ? "Resume when market conditions improve" : isCompleted ? "Crop cycle completed" : (crop.nextMilestone || "-");
  return <div className="bg-white rounded-2xl border border-[var(--hw-neutral-200)] shadow-[var(--shadow-xs)] p-4 flex flex-col gap-3">
      ...
      <div className="space-y-1.5">
        ...
        <DataRow label="Current price" value={price ? `\u20B1${price}/kg` : "-/kg"} />
