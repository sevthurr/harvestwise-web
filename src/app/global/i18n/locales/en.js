...
export const en = {
  ...
  auth: {
    ...
    sign_out: "Sign Out",
    login_title: "Sign in",
    login_subtitle: "Access your HarvestWise account",
    register_title: "Create your farmer account",
    register_subtitle: "Join HarvestWise to track crop prices and plan harvests",
    email_or_mobile: "Email or mobile number",
    email_or_mobile_required: "Email or mobile number *",
    contact_placeholder: "name@example.com or 09XXXXXXXXX",
    ...
    suffix: "Suffix",
    suffix_optional: "Suffix (optional)",
    suffix_not_applicable: "Not Applicable",
    ...
    google_unavailable_parentheses: "(unavailable)",
    ...
    dont_have_account: "Don't have a Farmer account?",
    ...
    errors: {
      identifier_required: "Enter your email or mobile number.",
      email_invalid: "Enter a valid email address.",
      phone_invalid: "Enter a valid Philippine mobile number.",
  ...
  onboarding: {
    ...
    use_location_helper: "Use this if you are currently at your farm.",
    enter_farm_address: "Enter farm address",
    ...
    purok_sitio_placeholder: "e.g. Purok 3 or Sitio Buda",
    purok_sitio_select_placeholder: "Search or select a Purok / Sitio",
    street: "Street",
    street_placeholder: "e.g. Davao-Bukidnon Highway",
    street_select_placeholder: "Search or select a Street",
    gps_barangay_missing: "We got your location, but please select your Barangay to finish.",
    specific_farm_address: "Specific farm location",
    specific_farm_address_placeholder: "Purok, Sitio, street, road, or nearby landmark",
    find_farm_location: "Find farm location",
    locate_address: "Find farm location",
    locating_address: "Locating farm...",
    location_ready: "Location confirmed",
    address_not_specific: "We couldn't find the exact farm location. Add a nearby road or landmark and try again.",
    farm_size: "Farm Size",
    city_placeholder: "Davao City",
    district_placeholder: "e.g. Marilog",
    district_select_placeholder: "Search or select a District",
    barangay_placeholder: "e.g. Buda",
    barangay_select_placeholder: "Search or select a Barangay",
    barangays_loading: "Loading Barangays...",
    barangays_error: "Barangays couldn't be loaded. Please try again.",
    geocoding_loading: "Locating farm area...",
    geocoding_error: "Could not locate this address. Please check and try again.",
    gps_denied: "Location access wasn't allowed. Enter your farm address instead.",
  ...
  farmer: deepMerge({
    ...
    factors: {
      ...
      weather: {
        ...
        location_required_title: "Add your farm location to see weather for your area.",
        location_required_desc: "Add your farm location to see weather information for your area.",
        add_location_btn: "Set Farm Location",
