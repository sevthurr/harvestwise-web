export const emptyStates = {
  no_crops: "Wala pay mga natala nga tanom.",
  no_crops_desc: "Magdugang og plano sa tanom o assessment aron masubay ang imong mga tanom.",
  no_prices: "Walay datos sa presyo nga magamit.",
