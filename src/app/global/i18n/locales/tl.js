...
export const tl = {
  common: {
    ...
    none: "Wala",
    not_applicable: "Hindi Aplikable",
    default: "Default",
    status: "Katayuan",
  ...
  auth: {
    ...
    sign_up_loading: "Gumagawa ng account…",
    sign_out: "Mag-log out",
    login_title: "Mag-sign in",
    login_subtitle: "I-access ang iyong HarvestWise account",
    register_title: "Gumawa ng farmer account",
    ...
    suffix_not_applicable: "Hindi Aplikable",
    ...
    confirm_password_required: "Kumpirmahin ang Password *",
    confirm_password_placeholder: "Ulitin ang iyong password",
    forgot_password: "Nakalimutan ang password?",
    google_sign_in: "Mag-sign in gamit ang Google",
    google_sign_up: "Mag-sign up gamit ang Google",
    google_unavailable: "Hindi available",
    google_unavailable_parentheses: "(hindi available)",
    ...
    dont_have_account: "Wala ka pang Farmer account?",
    ...
    errors: {
      identifier_required: "Ilagay ang iyong email o mobile number.",
      email_invalid: "Maglagay ng valid na email address.",
      phone_invalid: "Maglagay ng valid na Philippine mobile number.",
      password_required: "Ilagay ang iyong password.",
      first_name_required: "Ilagay ang iyong pangalan.",
      last_name_required: "Ilagay ang iyong apelyido.",
      password_requirements: "Hindi naabot ng password ang lahat ng kailangan.",
      password_mismatch: "Hindi magkapareho ang mga password.",
      invalid_credentials: "Maling email/phone o password.",
    ...
    requirements: {
      min_chars: "Hindi bababa sa 8 character",
      uppercase: "Hindi bababa sa 1 malaking titik",
      number: "Hindi bababa sa 1 numero",
      special_char: "Hindi bababa sa 1 espesyal na character",
    },
  },
  onboarding: {
    ...
    use_location: "Gamitin ang kasalukuyan kong lokasyon",
    use_location_helper: "Gamitin ito kung nasa iyong sakahan ka ngayon.",
    enter_farm_address: "Ilagay ang address ng sakahan",
    farm_location_label: "Lokasyon ng sakahan",
    ...
    purok_sitio_placeholder: "halimbawa: Purok 3 o Sitio Buda",
    purok_sitio_select_placeholder: "Hanapin o piliin ang Purok / Sitio",
    street: "Street",
    street_placeholder: "halimbawa: Davao-Bukidnon Highway",
    street_select_placeholder: "Hanapin o piliin ang Street",
    gps_barangay_missing: "Nakuha ang iyong lokasyon, ngunit pakiusap piliin ang iyong Barangay para matapos.",
    specific_farm_address: "Detalye ng lokasyon ng sakahan",
    specific_farm_address_placeholder: "Purok, Sitio, kalsada, o malapit na landmark",
    find_farm_location: "Hanapin ang lokasyon ng sakahan",
    locate_address: "Hanapin ang lokasyon ng sakahan",
    locating_address: "Hinahanap ang sakahan...",
    location_ready: "Nakumpirma ang lokasyon",
    address_not_specific: "Hindi mahanap ang eksaktong lokasyon ng sakahan. Magdagdag ng malapit na kalsada o landmark at subukang muli.",
    farm_size: "Laki ng Sakahan",
    city_placeholder: "Davao City",
    district_placeholder: "halimbawa: Marilog",
    district_select_placeholder: "Hanapin o piliin ang Distrito",
    barangay_placeholder: "halimbawa: Buda",
    barangay_select_placeholder: "Hanapin o piliin ang Barangay",
    barangays_loading: "Nilo-load ang mga Barangay...",
    barangays_error: "Hindi ma-load ang mga Barangay. Subukang muli.",
    geocoding_loading: "Hinahanap ang lugar ng sakahan...",
    geocoding_error: "Hindi mahanap ang coordinates para sa address na ito. Pakisubukan muli.",
    gps_denied: "Hindi pinayagan ang access sa lokasyon. Ilagay na lang ang address ng iyong sakahan.",
    gps_unavailable: "Hindi makuha ang iyong lokasyon. Subukang muli o ilagay ang address ng iyong sakahan.",
    gps_outside_davao: "Sa Davao City pa lamang sinusuportahan ng HarvestWise ang lokasyon ng sakahan. Ilagay na lang ang address ng iyong sakahan.",
    accuracy_warning: "Pakisuri kung tama ang natukoy na Barangay.",
    location_required_error: "Pakikumpirma ang lokasyon ng iyong sakahan.",
  ...
  farmer: deepMerge({
    ...
    factors: {
      price: {
        ...
        wholesale_notice: "Ang presyo ng wholesale ay karaniwang 15–20% mas mababa kaysa retail. ",
      ...
      weather: {
        ...
        location_required_title: "Ilagay ang lokasyon ng iyong sakahan upang makita ang panahon sa iyong lugar.",
        location_required_desc: "Ilagay ang lokasyon ng iyong sakahan upang makita ang impormasyon sa panahon sa iyong lugar.",
        add_location_btn: "I-set ang Lokasyon ng Sakahan",
    ...
    calendar: {
      driver_payday_detail: "Ang darating na panahon ng suweldo ay sumusuporta sa pagbili sa mga pamilihan ngayong linggo.",
      opportunity_payday_detail: "Ang mga panahon ng suweldo ay karaniwang sumusuporta sa mas mataas na presyo sa retail.",
      weather_note_storm: "Inaasahan ang malakas na pag-ulan na may kasamang kidlat at kulog{rain_mm}. Iwasan ang pagtatanim at protektahan ang mga naani.",
