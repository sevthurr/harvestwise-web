export const emptyStates = {
  no_crops: "Wala pang sinusubaybayang pananim.",
  no_crops_desc: "Magdagdag ng plano sa pananim o pagsusuri upang masubaybayan ang iyong mga pananim.",
  no_prices: "Walang available na datos ng presyo.",
